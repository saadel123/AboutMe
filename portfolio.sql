...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2023 at 10:01 AM
...
INSERT INTO `educations` (`id`, `title_fr`, `title_en`, `lieu`, `datedebut`, `datefin`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Diplôme de Technicien Spécialisé en Développement Informatique', 'Specialized Technician Diploma in Computer Development', 'ISTA HH1 | Casablanca, Maroc', '2020-09-01', '2022-07-23', '2023-11-23 10:12:06', '2023-11-24 14:35:34', NULL),
(2, 'Baccalauréat Science Physique Et Chimie.', 'Bachelor\'s Degree in Physical and Chemical Sciences', 'IBNO ROCHDE | Casablanca, Maroc', '2018-09-01', '2019-07-01', '2023-11-23 10:14:46', '2023-11-24 14:35:59', NULL);
...
INSERT INTO `services` (`id`, `title_fr`, `description_fr`, `title_en`, `description_en`, `icon`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Développement Complet d\'Applications Web et Logiciels', 'Concevoir, développer et déployer des applications web et des logiciels en utilisant les dernières technologies et les meilleures pratiques. Intégration des langages de programmation tels qu\'HTML, CSS, JavaScript, Laravel 9/PHP, Vue.js et Bootstrap 5 pour des solutions robustes et évolutives.', 'Full Development of Web Applications and Software', 'Design, develop, and deploy web applications and software using the latest technologies and best practices. Integration of programming languages such as HTML, CSS, JavaScript, Laravel 9/PHP, Vue.js, and Bootstrap 5 for robust and scalable solutions.', 'services/icon/TOcD6E0ValMRW85VrvXoYl5KurRUPNh1yW4S0uXQ.png', '2023-11-23 13:09:59', '2023-11-24 14:38:38', NULL),
(2, 'Optimisation et Maintenance Continue', 'Assurer la maintenance régulière des applications existantes pour garantir leur performance, leur sécurité et leur convivialité. Proposer des mises à jour proactives en fonction des évolutions technologiques pour maximiser l\'efficacité et l\'expérience utilisateur.', 'Optimization and Continuous Maintenance', 'Ensure regular maintenance of existing applications to guarantee their performance, security, and user-friendliness. Propose proactive updates based on technological advancements to maximize efficiency and user experience.', 'services/icon/Myo3JFvG0k6t5QpFwtuRUGXyXgjCbf8j3Dpx9uoA.png', '2023-11-23 13:10:19', '2023-11-24 14:39:15', NULL),
(3, 'Résolution de Problèmes Techniques et Amélioration Continue', 'Diagnostiquer et résoudre rapidement les problèmes techniques et les bugs dans les applications existantes. Proposer des solutions innovantes pour améliorer l\'efficacité et la qualité du code, tout en assurant une expérience utilisateur optimale.', 'Technical Problem Solving and Continuous Improvement', 'Diagnose and promptly resolve technical issues and bugs in existing applications. Propose innovative solutions to enhance code efficiency and quality, ensuring an optimal user experience.', 'services/icon/jmItxcSUdApoG8yXInKQgo1PbDhUyiNkPfY0ct6Z.png', '2023-11-23 13:10:35', '2023-11-24 14:39:55', NULL);
