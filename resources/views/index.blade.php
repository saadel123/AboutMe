    ...
    <section id="skills" class="skills section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row skills-content">
                ...
                <div class="col-lg-6">
                    <div class="progress">
                        <span class="skill">{{ $skill->langage }} <i class="val">{{ $skill->percent }}</i></span>
            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="100">
                    @foreach ($projects as $project)
                        ...
                        <div class="portfolio-info">
                            <p>{{ $project->{'title_' . app()->getLocale()} }}</p>
                            <a href="{{ 'storage/' . $project->image }}"  data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="{{ route('single.project', $project->id) }}" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <form id="contact-form" role="form" class="php-email-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                <input type="email" class="form-control" name="email" id="email" placeholder="{!! __('home.Contact.email') !!}" required>
                            </div>
                        </div>
