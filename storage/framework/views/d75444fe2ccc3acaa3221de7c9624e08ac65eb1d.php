...
<div class="col-12">
    ...
    <textarea name="description_fr" class="form-control" id="description_fr" required >  <?php echo e(old('description_fr', $project->description_fr ?? '')); ?></textarea>
</div>
<div class="col-12">
    <label for="description_en" class="form-label">Description En</label>
    <textarea name="description_en" class="form-control" id="description_en" required >  <?php echo e(old('description_en', $project->description_en ?? '')); ?></textarea>
</div>
<div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\portfolio\resources\views/admin/layouts/forms/projects.blade.php ENDPATH**/ ?>