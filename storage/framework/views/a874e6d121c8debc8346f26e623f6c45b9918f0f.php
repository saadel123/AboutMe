    ...
    <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3 me-4">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                ...
                <li>
                    <a class="dropdown-item text-center" href="<?php echo e(url('/')); ?>">
                ...
                <li>
                    <?php if(Auth::check()): ?>
                        <a class="dropdown-item text-center" href="<?php echo e(url('/')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
</nav><?php /**PATH C:\xampp\htdocs\portfolio2024\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>