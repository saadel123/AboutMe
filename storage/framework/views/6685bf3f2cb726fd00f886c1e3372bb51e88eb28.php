...
<?php $__env->startSection('content'); ?>
    <section id="hero" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <p><span class="typed" data-typed-items="<?php echo __('home.devweb'); ?>"></span></p>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    ...
                    <p style="white-space: break-spaces;"><?php echo __('home.about.description'); ?></p>
                </div>
                <div class="row">
                    <div class="col-lg-10 m-auto pt-4 pt-lg-0 content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong><?php echo __('home.about.age'); ?> :</strong>
                                        <span>24</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong><?php echo __('home.about.dpl'); ?> :</strong>
                                        <span>Bac +2</span>
                                    </li>
                            ...
                            <div class="portfolio-wrap portfolio-img"
                                ...
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        ...
                                        <a href="<?php echo e(route('single.project', $project->id)); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portfolio2024\resources\views/index.blade.php ENDPATH**/ ?>