...
<div class="col-12">
    ...
    <textarea name="description_fr" class="form-control @error('description_fr') is-invalid @enderror" id="description_fr" rows="9">{{ old('description_fr', $experience->description_fr ?? '') }}</textarea>
...
<div class="col-12">
    ...
    <textarea name="description_en" class="form-control @error('description_en') is-invalid @enderror" id="description_en" rows="9">{{ old('description_en', $experience->description_en ?? '') }}</textarea>
...
<div class="col-12">
    ...
    <textarea name="description_de" class="form-control @error('description_de') is-invalid @enderror" id="description_de" rows="9">{{ old('description_de', $experience->description_de ?? '') }}</textarea>
