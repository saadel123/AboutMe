                    ...
                    <div class="col-sm-12">
                        <nav class="main-menu">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="/index"><img class="logo" src="assests/images/logo-color.png"
                                        alt="AboutMe"></a>
                            </div>
                            <!--End navbar-header -->
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="post-image">
                        <img src="assests/images/service/service-img1.jpg" alt="Graphic Design">
                    </div><!-- end post-image -->
                    <div class="title-box">
                    ...
                    <div class="service-content">
                        ...
                        <p>Cum oblique suscipit ut, duis intellegat ex duo. Vis ei omnis equidem, his in commodo
                            intellegat, primis dictas iudicabit id cum. Quo ut posse postulant. Zril nostrud
                            mediocritatem sit ad, his eruditi alienum te, omnesque atomorum argumentum ius ei.</p>
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <img src="assests/images/service/service-img2.jpg" alt="">
                            </div><!-- end col -->
                        </div><!-- end row -->
                        <p>He lay on his armour-like back, and if he lifted his head a little he could see his brown
                            ...
                            to cover it and seemed ready to slide off any moment.</p>
                        <p>Cum oblique suscipit ut, duis intellegat ex duo. Vis ei omnis equidem, his in commodo
                            intellegat, primis dictas iudicabit id cum. Quo ut posse postulant. Zril nostrud
                            mediocritatem sit ad, his eruditi alienum te, omnesque atomorum argumentum ius ei.</p>
                        <p>A collection of textile samples lay spread out on the table - Samsa was a travelling salesman
                            - and above it there hung a picture that he had recently cut out of an illustrated magazine
                            and housed in a nice, gilded frame. It showed a lady fitted out with a fur hat and fur boa
                            who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards
                            the viewer. Gregor then turned to look out the window at the dull weather.</p>
                            ...
                            <div class="panel panel-default item">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        Quas laoreet euripidis ius cu, usu ipsums virtute eleifend an. Elitr minimum
                                        enasp molestie eam ad, et soluta noster effics iantur usu. In eam partiendo
                                        disputando.
                                    </div>
                    ...
                    <div id="serviceQuoteForm" class="quoteForm-holder2">
                        <form id="quoteForm" name="free-quote" data-toggle="validator" class="quoteForm">
                            ...
                            <div class="form-group">
                                ...
                                <input name="fname" id="quoteName" placeholder="Full Name*" class="form-control"
                                    required data-error="Please enter Name" type="text">
                                <div class="input-group-icon"><i class="fa fa-user"></i></div>
                            </div><!-- end form-group -->
                            <div class="form-group">
                                <div class="help-block with-errors"></div>
                                <input name="email" id="quoteEmail" placeholder="Email Address*"
                                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" class="form-control" required
                                    data-error="Please enter valid Email" type="email">
                                <div class="input-group-icon"><i class="fa fa-envelope"></i></div>
                            </div><!-- end form-group -->
                            <div class="form-group">
                                <div class="help-block with-errors"></div>
                                <input name="phone" id="quotePhone" placeholder="Phone Nunber*" class="form-control"
                                    required data-error="Please enter valid Phone" type="text">
                                <div class="input-group-icon"><i class="fa fa-phone"></i></div>
                            </div><!-- end form-group -->
                            <div class="form-group">
                                <div class="help-block with-errors"></div>
                                <input name="address" id="address" placeholder="Address*" class="form-control" required
                                    data-error="Please enter Address" type="text">
                                <div class="input-group-icon"><i class="fa fa-map-marker"></i></div>
                            </div><!-- end form-group -->
                            <div class="form-group">
                                <div class="help-block with-errors"></div>
                                <select name="service" id="quoteService" class="form-control" required
                            ...
                            <div class="form-group bottomMargin0">
                                <button type="submit" id="quoteSubmit" class="btn btn-shutter-out-horizontal disabled"
                                    style="pointer-events: all; cursor: pointer;">Send Request</button>
                            </div>
                        ...
                        <div class="columnbottom-margin contact-info-wrap">
                            ...
                            <ul class="contact-info list-unstyled">
                                ...
                                <li><i class="fa fa-envelope"></i> <a
                                        href="mailto:sales@yourwebsite.com">sales@yourwebsite.com</a></li>
                            </ul><!-- end contact-info  -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <a href="#" class="footer-logo-link"><img class="footer-logo" src="assests/images/footer-logo.png"
                            alt="Steve"></a>
                    <p class="text-center copyright">&copy; 2019 <a href="https://1.envato.market/kPy00"
                            class="footer-site-link">MGScoder</a> All rights reserved. <a
                            href="https://1.envato.market/7B3dY" class="footer-site-link">Buy AboutMe HTML Template</a>
                    </p>
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
